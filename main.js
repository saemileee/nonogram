import { paintStage } from "./renderPuzzle.js";
...
fetch("puzzle.json")
  ...
  .then((puzzleDB) => {
    ...
    function puzzleListTitlesClickHandler(e) {
      ...
      PaintStage(puzzleID, puzzleArr);
      window.history.pushState(null, "", `/nemmologic/puzzle/${puzzleID}`);
    }
  });

paintStage(puzzleID, puzzleArr);
// function PaintStage(puzzleID, puzzleArr) {
